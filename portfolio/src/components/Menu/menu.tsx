    ...
    return (
        <div>
            <div className="flex items-center justify-center w-full h-screen">
                <div className="p-10 flex flex-col items-center justify-center w-1/3 m-10 h-2/3 border-white border-solid border-2 shadow-slate-300 shadow-lg rounded-lg">
                    ...
                    <Link className="text-white border-black border-solid border-2 p-3 bg-fiap rounded-md hover:bg-black hover:border-white  transition duration-500 " href="/us/jennifer">CheckPoints</Link>
                </div>
                <div className="p-10 flex flex-col items-center justify-center w-1/3 m-10 h-2/3 border-white border-solid border-2 shadow-slate-300 shadow-lg rounded-lg">
                    ...
                    <Link className="text-white border-black border-solid border-2 p-3 bg-fiap rounded-md hover:bg-black hover:border-white  transition duration-500 " href="">Global Solution</Link>
                </div>
                <div className="p-10 flex flex-col items-center justify-center w-1/3 m-10 h-2/3 border-white border-solid border-2 shadow-slate-300 shadow-lg rounded-lg">
